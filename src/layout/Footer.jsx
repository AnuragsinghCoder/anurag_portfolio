...
const socialLinks = [
  { icon: FaGithub, href: "https://github.com/AnuragsinghCoder", label: "GitHub" },
  { icon: FaLinkedin, href: "https://www.linkedin.com/in/anurag-singh-x-dev/", label: "LinkedIn" },
  { icon: FaTwitter, href: "https://x.com/ANURAGs19794745", label: "Twitter" },
];
